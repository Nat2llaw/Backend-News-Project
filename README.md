...
When cloning this repo, you will noot have access to the necessary env variables. Therefore, set up two .env files titled '.env.test' and '.env.development' and connect to the two local databases in setup.sql using PGDATABASE.